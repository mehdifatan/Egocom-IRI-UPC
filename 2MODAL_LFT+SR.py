...
def train_epoch(model1, model2, modals, x_train, y_train, optim1, optim2, device, criterion1, criterion2, start_time):
    model1.train()
    model2.train()
...
def eval_epoch(model1, model2, modals, x_val, y_val, device, criterion1, criterion2):
    model1.eval()
    model2.eval()
...
def main():
    ...
    for epoch in range(max_epoch):
        train_loss, train_accuracy = train_epoch(model1,model2, modals, x_tr_dl, y_tr_dl,optim1,optim2,device, criterion1, criterion2, start_time)
        loss_values.append(train_loss)
        train_acc_values.append(train_accuracy)
        print('Epoch: %03i/%03i | Train Loss: %.3f | Accuracy: %.3f'%(epoch+1, max_epoch, train_loss ,train_accuracy))
        val_loss, val_accuracy = eval_epoch(model1,model2, modals, x_val_dl, y_val_dl, device, criterion1, criterion2)
        ...
        test_loss,test_accuracy = eval_epoch(model1,model2, modals, x_test_dl, y_test_dl, device, criterion1, criterion2)
